<template>
  <section class="bg-white py-5 overflow-hidden relative z-10">
    <div class="container">
        ...
        <div class="w-full lg:w-1/2 xl:w-6/12 px-4">
          <div class="max-w-[570px] mb-12 lg:mb-0">
            ...
            <div class="flex mb-8 max-w-[370px] w-full">
              <div
                class="max-w-[60px] sm:max-w-[70px] w-full h-[60px] sm:h-[70px] flex items-center justify-center mr-6 overflow-hidden bg-indigo-600 bg-opacity-5 text-indigo-600 rounded"
              >
                <svg
                  width="24"
                  height="24"
          ...
          <div class="bg-white relative rounded-lg p-8 sm:p-12 shadow-lg">
            <form>
              <div class="mb-6">
                <input
                  ...
                  class="w-full rounded py-3 px-[14px] text-body-color text-base border border-[f0f0f0] outline-none focus-visible:shadow-none focus:border-indigo-600"
                />
              </div>
              <div class="mb-6">
                <input
              ...
              <div class="mb-6">
                <textarea
                  ...
                  class="w-full rounded py-3 px-[14px] text-body-color text-base border border-[f0f0f0] resize-none outline-none focus-visible:shadow-none focus:border-indigo-600"
                ></textarea>
              </div>
              <div>
                <button
                  type="submit"
                  class="w-full text-white bg-indigo-500 rounded border border-indigo-300 p-3 transition hover:bg-opacity-90"
                >
                  Send Message
                </button>
              </div>
            ...
            <div>
              ...
              <span class="absolute -right-10 top-[90px] z-[-1]">
                <img
                  src="../assets/images/contact_circles.svg"
                  alt="contacts circles"
                />
              </span>
              <span class="absolute -left-7 -bottom-7 z-[-1]">
                <img
                  src="../assets/images/contact_circles_2.svg"
                  alt="contacts circles 2"
                />
              </span>
            </div>
          </div>
